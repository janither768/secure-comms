...
let db = {};
let activeUsers = {}; 
let roomConstraints = {}; // Now stores { target: 'Name', creator: 'Name' }
...
app.get('/chat', (req, res) => {
  ...
  // Allow entry if no constraints, OR if user is Creator, OR if user is Target
